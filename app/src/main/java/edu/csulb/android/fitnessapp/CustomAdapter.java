...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(inspirationActivity mainActivity, String[] prgmNameList, int[] prgmImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.activity_inspiration_list, null);
